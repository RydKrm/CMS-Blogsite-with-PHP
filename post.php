        ...
        <div class="row">
            ...
            <div class="col-lg-8">
              ...
              ?>
                ...
                <!-- Title -->
                <h1><a href="view_post.php?view_post=<?php echo $post_id ?>"><?php echo $post_title ?> </a></h1>
                ...
                <!-- Preview Image -->
                <img class="img-responsive" src="http://placehold.it/900x300" alt="Image Not Found">
                ...
                <!-- <input type="submit" value="See More" name="see_more" class="btn btn-primary"> -->
                 ...
                 <h3><a href='view_post.php?view_post=<?php echo $post_id ?>' > See More</a></h3>
